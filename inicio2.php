...
<html>
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <!-- Head Section -->
            <section class="small-section bg-dark-alfa-30 parallax-2" data-background="images/portada.jpg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-30">
                            <div class="mod-breadcrumbs font-alt align-right">
                                <a href="#">Home</a>&nbsp;/&nbsp;<a href="#">Portfolio</a>&nbsp;/&nbsp;<span>Parallax</span>
                            </div>
            ...
            <!-- Section -->
            <section class="page-section fixed-height-small pt-0 pb-0 bg-dark-alfa-30" data-background="images/full-width-images/section-bg-12.jpg">
