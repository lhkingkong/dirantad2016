...
$mail->Password   = "2014antad03";        // SMTP account password

$administrador = "dirantad@ipsight.net";
$administrador = "btouleau@ipsight.net";
...
$mail->Subject    = "Nueva solicitud de acceso al directorio ANTAD 2014";
//$mail->AltBody    = "To view the message, please use an HTML compatible email viewer!"; // optional, comment out and test
$mail->CharSet = 'UTF-8';

$body = '<p>Se registr&oacute; una nueva solicitud de acceso al directorio ANTAD 2014</p>';
...
$mailconfirm->Password   = "2014antad03";        // SMTP account password
...
$mailconfirm->Subject	= "Registro de su solicitud de acceso al directorio ANTAD 2014";
...
<body>
<p>Estimado/a '. $nombre_completo .', hemos recibido su solicitud de acceso al directorio ANTAD 2014</p>

<p>El pago de los $1,000 puede ser a trav&eacute;s de transferencia electr&oacute;nica o dep&oacute;sito.</p>

<table style="color:blue;font-size: 12px;">
<tr>
                        <td>RAZON SOCIAL DE LA EMPRESA:</td><td>XCD DESARROLLADORA S.A. DE C.V.</td>
</tr> 
<tr>                       
                        <td>DIRECCION FISCAL, COMERCIAL:</td><td>HORACIO NO. 1855-6° PISO, COL. CHAPULTEPEC MORALES,</td>
</tr> 
<tr>
                        <td>Y ADMINISTRATIVA</td><td>11570, MEXICO, D.F.</td>
</tr> 
<tr>
                        <td>GIRO:</td><td>SERVICIOS AL COMERCIO</td>
</tr> 
<tr>
                        <td>R.F.C.:</td><td>XDE1111184P6</td>
</tr> 
<tr>
                        <td>TELEFONO:</td><td>01 (55) 5580 1772 EXT. 231</td>
</tr> 
<tr>
                        <td>FAX:</td><td>01 (55) 5395 2611</td>
                </tr></table>
                <p>TRANSFERENCIA:</p>
<table style="color:blue;font-size: 12px;">
                <tr>
                        <td>NOMBRE DEL BANCO:</td><td>BANAMEX</td>
</tr> 
<tr>
                        <td>NUMERO DE CUENTA:</td><td>7132320</td>
</tr> 
<tr>
                        <td>NUMERO DE SUCURSAL:</td><td>7003</td>
</tr> 
<tr>
                        <td>EJECUTIVO:</td><td>LAURA PERALTA</td>
</tr> 
<tr>
                        <td>DIRECCION DEL BANCO:</td><td>EJERCITO NACIONAL 966 LOS MORALES POLANCO</td>
</tr> 
<tr>
                        <td>NOMBRE DE LA PLAZA:</td><td>MEXICO D.F.</td>
</tr> 
<tr>
                        <td>CLABE INTERBANCARIA:</td><td>002180700371323207</td>
</tr> 
<tr>
                        <td>SWIFT:</td><td>BNMXMXMM</td>
                </tr></table>
