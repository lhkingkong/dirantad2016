...
function mail2($correo, $asunto, $mensaje, $header) {
	...
	try {
        ...
        $mail->Port =  587;//465;//   $port;                 // set the SMTP server port
	mail->Mailer = 'smtp';  
        $mail->Host = 'mail.ipsight.net'; //"mail.unixhelp.com.mx"; // SMTP server
        $mail->Username = 'dirantad@ipsight.net'; //"peterpedro@unixhelp.com.mx";     // SMTP server username
        $mail->Password = '2014dirantad13'; //"ZeN564un1x";            // SMTP server password
        $mail->IsSendmail();  // tell the class to use Sendmail
        //$mail->AddReplyTo("name@domain.com","First Last");
        $mail->From = "dirantad@ipsight.net"; //" peterpedro@unixhelp.com.mx";
	$mail->CharSet = 'UTF-8';
        $mail->FromName = "Prueba";//utf8_decode("El Colegio de México, A.C."); //" peterpedro";

        $mail->AddAddress('lhkingkong@hotmail.com');
