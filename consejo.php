      ...
      <?php include "menu.php" ?>
          ...
          <div class="relative container align-left">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <h1 class="font-alt" align="center">El Consejo Directivo</h1>
              </div>
        ...
        <section class="page-section">
          <div class="container relative">
            <div class="col-md-12">
              <p>El consejo directivo está constituído por los asociados fundadores, asociados estratégicos y asociados activos</p>

              <div class="boxA">
                <h3 class="text_higlight">CONSEJO DIRECTIVO ANTAD 2015</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <h3 class="text_higlight">Asociados Fundadores</h3>
                <div class="list_block">
                  <ul>
              ...
              <div class="col-md-4">
                <h3 class="text_higlight">Asociados Activos</h3>
                <div class="list_block">
                  <ul>
                    <li>CIA COMERCIAL CIMACO, S.A. DE C.V.</li>
                    <li>EL NUEVO MUNDO, S.A. DE C.V.</li>
                    ...
                    <li>TIENDAS DE AUTOSERVICIO DEL NORTE, S.A. DE C.V.</li>
              ...
              <div class="col-md-4">
                <h3 class="text_higlight">Asociados Estratégicos</h3>
                <div class="list_block">
                  <ul>
