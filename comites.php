          ...
          <div class="relative container align-left">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <h1 class="font-alt" align="center">Comités de Trabajo</h1>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <dl class="toggle">
                  ...
                  <dd>
                    <p><span class="text_higlight">Presidente: </span>TIENDAS COMERCIAL MEXICANA, S.A. DE C.V.
                      <br>
                  ...
                  <dd>
                    <div>
                      <span class="text_higlight">Consejero Delegado: </span> TIENDAS COMERCIAL MEXICANA, S.A. DE C.V.
                      <div><span class="text_higlight">Contacto ANTAD:</span> Lic. Manuel Cardona Zapata y Lic. Mónica Leñero Álvarez</div>
                    </div>
                  ...
                  <dd>
                    <div><span class="text_higlight">Consejero Delegado: </span> OPERADORA DE CIUDAD JUÁREZ, S.A. DE C.V.
                      <br>
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Manuel Cardona Zapata y Lic. Mónica Leñero Álvarez</div>
                    <div><span class="text_higlight">Misión: </span> Promover mejora regulatoria en las operaciones de Comercio Exterior de nuestros Asociados y fortalecer la competitividad de los Asociados de ANTAD que tienen establecimientos en las franjas.</div>
                    <h5>AGENDA CON EL PODER EJECUTIVO</h5>
                    <ul>
                  ...
                  <dd>
                    <div><span class="text_higlight">Consejero Delegado: </span> OFFICE DEPOT, S.A. DE C.V.
                      <br />
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Angélica Medel Moreno</div>
                    <div><span class="text_higlight">Misión: </span> Establecer los mecanismos de comunicación que permitan fortalecer la imagen de los Asociados, así como difundir los trabajos que realiza ANTAD en beneficio del consumidor.</div>
                    <ul>
                  ...
                  <dd>
                    <div><span class="text_higlight">Consejero Delegado: </span> TIENDAS COMERCIAL MEXICANA, S.A. DE C.V.
                      <br />
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Manuel Cardona Zapata</div>
                    <div><span class="text_higlight"> Misión: </span> Analizar y difundir las leyes que la S.H.C.P. dispone y emite en relación con la aplicación de los impuestos y otras contribuciones fiscales que afectan las funciones administrativas y operativas de la Asociación.</div>
                    <h5>TEMÁTICA FISCAL</h5>
                    <ul>
                  ...
                  <dd>
                    <div><span class="text_higlight">Consejero Delegado: </span> FARMACIA GUADALAJARA, S.A. DE C.V.
                      <br />
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Manuel Cardona Zapata</div>
                    <div><span class="text_higlight">Misión:</span> Propiciar la modernización del mercado y su comercialización en beneficio de los Consumidores a través de la libre competencia.</div>
                  ...
                  <dd>
                    <div><span class="text_higlight">Presidente:</span> TIENDAS COMERCIAL MEXICANA, S.A. DE C.V.
                      <br />
                      <span class="text_higlight">Contacto ANTAD:</span> Ing. Daniel Greaves Munguía</div>
                    <ul>
                  ...
                  <dd>
                    <p><span class="text_higlight">Consejero Delegado:</span> WAL-MART DE MÉXICO, S. DE R.L. DE C.V.
                      <br />
                      <span class="text_higlight"> Vicepresidente:</span> CORPORACIÓN CONTROL, S.A. DE C.V.
                      <br />
                    ...
                    <h5>AGENDA LEGISLATIVA</h5> En sinergia y colaboración con CCE:
                    <ul>
                  ...
                  <dd>
                    <p><span class="text_higlight">Consejero Delegado:</span> TIENDAS CHEDRAUI, S.A. DE C.V.
                      <br />
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Cecilia Cáceres Fox</p>
                    <p><span class="text_higlight">Misión:</span></p>
                    <ul>
                  ...
                  <dd>
                    <p><span class="text_higlight">Consejero Delegado:</span> EL PUERTO DE LIVERPOOL, S.A.B. DE C.V.
                      <br/>
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Manuel Cardona Zapata y Lic. Mónica Leñero Álvarez</p>
                    <p><span class="text_higlight">Misión:</span> Mantener e incrementar relaciones con autoridades Municipales, Estatales y Federales mostrándoles la importancia de ANTAD y sus Asociados en la actividad económica del país.</p>
                    ...
                    <h5>AGENDA  LEGISLATIVA</h5> Distrito Federal
                    <ul>
                  ...
                  <dd>
                    <p><span class="text_higlight">Consejero Delegado:</span> TIENDAS COMERCIAL MEXICANA, S.A. DE C.V.
                      <br />
                      <span class="text_higlight">Contacto ANTAD:</span> Lic. Rogelio Rodríguez Morales</p>
